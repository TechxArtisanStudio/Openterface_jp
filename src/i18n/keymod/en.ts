...
export const en: KeymodLandingStrings = {
  ...
  modesTheater: {
    ...
    proTerminal: {
      ...
      lead: 'Open SSH sessions straight from KeyCmd. USB when wired. Bluetooth at the rack.',
      body: 'Terminal mode in KeyCmd: SSH over USB ECM (Plus) or BLE-Eth (Mini). Works with macOS and Linux targets today.',
...
pm2 reload ecosystem.config.js --env production`,
      ...
      terminal: {
        badge: 'Terminal',
        title: 'SSH from your phone',
        body: 'Dedicated Terminal mode runs SSH through the KeyMod bridge. Pick USB for speed at the machine or Bluetooth when you are across the room. Works with macOS and Linux targets today.',
        experimentalHint: '',
        demo: {
          interactiveDemoLabel: 'Interactive demo',
          title: 'Terminal Demo',
        ...
        usb: {
          ...
          body: 'Wired path when Plus is tethered to your phone. Higher throughput for full-size sessions at the rack.',
        },
        ble: {
          label: 'BLE-Eth · KeyMod Mini',
          body: 'Wireless SSH when Mini is on the target. Compact terminal geometry recommended.',
        },
        notice:
          'Terminal mode ships in KeyCmd today. Open SSH sessions over the KeyMod bridge on macOS and Linux targets. Windows target support via RNDIS is in development.',
      },
    },
    gameZone: {
      eyebrow: 'Game Zone',
  ...
  productJourney: {
    ...
    subtitle:
      'Eight milestones shipped. Limited engineering samples have been distributed. Crowdfunding is live on Crowd Supply.',
    scrollHint: '← Swipe for earlier milestones',
    nowLabel: 'Now',
    nowSublabel: 'Crowdfunding live on Crowd Supply',
    milestones: [
      {
        id: 'concept',
        status: 'done',
      ...
      },
      {
        id: 'cs-prelaunch',
        status: 'done',
        title: 'Crowd Supply campaign live',
        lead: 'Campaign is live. Back KeyMod to secure yours.',
      ...
      },
      {
        id: 'beta-2',
        status: 'done',
        title: 'Engineering samples distributed',
        lead: 'Limited engineering-grade units allocated to early supporters for real-world validation.',
      },
      {
        id: 'crowdfunding',
        status: 'done',
  ...
  subscribe: {
    ...
    benefits: [
      'Direct access to the Crowd Supply campaign',
