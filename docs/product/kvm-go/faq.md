...
Yes — certified by [OSHWA](https://certification.oshwa.org/cn000015.html). Hardware and software are on [GitHub](https://github.com/TechxArtisanStudio/Openterface_KVM-GO_Hardware).
